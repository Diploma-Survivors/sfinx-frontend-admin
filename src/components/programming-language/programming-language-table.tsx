...
function SortableRow({ language, t, onEdit, onDelete, onStatusChange }: SortableRowProps) {
    const {
        attributes,
        listeners,
        setNodeRef,
    ...
    return (
        <TableRow ref={setNodeRef} style={style} className={isDragging ? 'bg-slate-100 dark:bg-slate-800 shadow-lg' : ''}>
            ...
            <TableCell className="text-center">
                <Badge
                    variant="secondary"
                    className={language.isActive ? 'bg-primary/10 text-primary hover:bg-primary/20 border-primary/20' : ''}
                >
                ...
                <div className="flex justify-center gap-2">
                    {onStatusChange && (
                        <Button
                            ...
                            className={language.isActive ? "text-orange-500 hover:text-orange-600 hover:bg-orange-50" : "text-primary hover:text-primary hover:bg-primary/10"}
                        >
                            {language.isActive ? <Ban className="h-4 w-4" /> : <Check className="h-4 w-4" />}
                        </Button>
                    )}
                    {onEdit && (
                        <Button
