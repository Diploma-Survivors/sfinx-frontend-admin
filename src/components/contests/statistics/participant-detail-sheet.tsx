...
export function ParticipantDetailSheet({
  ...
  const { submissions, isLoading, hasMore, loadMore } = useInfiniteSubmissions({
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className="text-sm font-medium bg-slate-100 dark:bg-slate-800"
                    >
                      #{participant.rank}
                    </Badge>
                  </div>
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <span className="font-bold text-sm">
                        Q{status.problemOrder}
                      </span>
                      <Badge
                        variant="secondary"
                        className="bg-white/50 dark:bg-black/20 text-xs backdrop-blur-sm border-0"
                      >
                    ...
                    <div className="flex justify-between items-end text-xs opacity-80">
                      <span>{t("points", { count: status.score || 0 })}</span>
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  <TableBody>
                    ...
                    {isLoading && submissions.length > 0 && (
                      <TableRow>
                        <TableCell
                          colSpan={3}
                          className="h-12 text-center text-slate-500 text-xs"
                        >
                          {t("table.loadingMore")}
                        </TableCell>
                      </TableRow>
