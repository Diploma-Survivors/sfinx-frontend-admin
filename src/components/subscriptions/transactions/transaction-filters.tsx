                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Select value={statusFilter} onValueChange={(val) => setStatusFilter(val as PaymentStatus | 'ALL')}>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value={PaymentStatus.SUCCESS} className="cursor-pointer text-green-600 dark:text-green-400">
                                {t('status.success')}
                            </SelectItem>
                            <SelectItem value={PaymentStatus.PENDING} className="cursor-pointer text-yellow-600 dark:text-yellow-400">
                                {t('status.pending')}
                            </SelectItem>
                            <SelectItem value={PaymentStatus.FAILED} className="cursor-pointer text-red-600 dark:text-red-400">
                                {t('status.failed')}
                            </SelectItem>
                        </SelectContent>
                    </Select>
